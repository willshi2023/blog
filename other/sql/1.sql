...
CREATE TABLE `article` (
  ...
  `readCount` bigint(20) NOT NULL DEFAULT '0' COMMENT '阅读数',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

/*Data for the table `article` */

insert  into `article`(`id`,`title`,`summary`,`show_pictrue`,`createTime`,`readCount`) values (1,'微服务架构的技术体系——上线啦','花了一些时间对微服务架构体系的理论以及实践进行了总结。一部分课程已经整理完毕上线了。 课程链接：微服务架构的技术体系详解 课程简介： 微服务架构的技术体系、社区目前已经越来越成熟。在最初系统架构的搭建','/blog/images/1.jpg','2018-07-18',0),(2,'JVM性能调优实践——G1 垃圾收集器分','前言 关于G1 GC以及其他垃圾收集器的介绍可以参考前一篇JVM性能调优实践——G1 垃圾收集器介绍篇。了解了G1垃圾收集器的运行机制之后，就可以针对一些GC相关参数来调整内存分配以及运行策略。下文的','/blog/images/1.jpg',NULL,0);
...
insert  into `user_article`(`id`,`user_id`,`article_id`) values (1,1,1);
...
insert  into `user_dtl`(`id`,`introduce`) values (1,'一个写代码的');
